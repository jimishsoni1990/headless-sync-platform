...
final class CreateSystemProcessedEventsMigration extends AbstractSqlMigration
{
    public function __construct(private readonly ConnectionInterface $connection) {}

    public function getName(): string
    {
        return '0006_create_system_processed_events';
    }
    ...
    {
        return __DIR__ . '/0006_create_system_processed_events.sql';
    }
