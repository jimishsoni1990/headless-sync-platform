...
final class CreateSystemAggregateVersionsMigration extends AbstractSqlMigration
{
    public function __construct(private readonly ConnectionInterface $connection) {}

    public function getName(): string
    {
        return '0005_create_system_aggregate_versions';
    }
    ...
    {
        return __DIR__ . '/0005_create_system_aggregate_versions.sql';
    }
