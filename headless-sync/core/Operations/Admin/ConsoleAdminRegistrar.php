 ...
 * and the two nonce-protected admin-ajax actions the minimal polling JS calls. Kept as a
 * thin registrar (mirrors ContentSubscriberRegistrar / ReconciliationCronRegistrar) so the
 * controllers stay free of add_action() calls and remain unit-testable without WordPress.
 *
