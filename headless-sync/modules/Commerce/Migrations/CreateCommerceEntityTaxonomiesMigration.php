...
final class CreateCommerceEntityTaxonomiesMigration extends AbstractSqlMigration
{
    ...
    {
        return '0004_create_commerce_entity_taxonomies';
    }
    ...
    {
        return __DIR__ . '/0004_create_commerce_entity_taxonomies.sql';
    }
