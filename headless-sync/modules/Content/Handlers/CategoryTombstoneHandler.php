...
/**
 * Handles content.category.deleted — soft-deletes the content.taxonomies projection row.
 *
 ...
 *   DECISION 3         — three-op atomicity owned by CategoryAdapter.tombstone().
 *   ADR-012            — constructor injection only.
 */
final class CategoryTombstoneHandler implements ContentTombstoneHandlerInterface
{
