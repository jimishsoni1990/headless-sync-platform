...
final class AlignContentTaxonomyIndexesMigration extends AbstractSqlMigration
{
    ...
    {
        return '0008_align_content_taxonomy_indexes';
    }
    ...
    {
        return __DIR__ . '/0008_align_content_taxonomy_indexes.sql';
    }
