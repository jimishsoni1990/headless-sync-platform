...
| **P1A-S6** | Next.js validation + end-to-end DoD | Next.js consumer (external); full pipeline smoke | Doc 11 §24 (30-second SLA); Phase 1A DoD checklist | All Phase 1A DoD criteria pass: end-to-end sync, < 30s delay, atomicity, idempotency, stale-event skip, Next.js renders, module isolation, type-canon check | P1A-S6b |
